...
describe('McpTestClient', () => {
    ...
    describe('tool listing', () => {
        ...
        it('should list available tools', async () => {
            ...
            expect(toolNames).toContain(TOOL_NAMES.NAVIGATE);
            expect(toolNames).toContain(TOOL_NAMES.CLICK);
            expect(toolNames).toContain(TOOL_NAMES.TAKE_SCREENSHOT);
            expect(toolNames).toContain(TOOL_NAMES.GET_HTML);
            expect(toolNames).toContain(TOOL_NAMES.GET_CONSOLE);
            expect(toolNames).toContain(TOOL_NAMES.LIST_TAB_URLS);
        });
    ...
    describe('tool calling', () => {
        ...
        it('should fail tool calls when not initialized', async () => {
            ...
            await expect(uninitializedClient.navigate('https://example.com')).rejects.toThrow('Client not initialized');
        ...
        it('should call generic callTool method', async () => {
            const response = await client.callTool(TOOL_NAMES.LIST_TAB_URLS, {});
            expect(response).toBeDefined();
            expect(response.content).toBeDefined();
            expect(Array.isArray(response.content)).toBe(true);
            expect(response.isError).toBeDefined();
    ...
    describe('error handling', () => {
        it('should handle tool call errors gracefully', async () => {
            ...
            await expect(client.callTool(TOOL_NAMES.LIST_TAB_URLS, {})).rejects.toThrow('Client not initialized');
        });
