...
describe('findChromiumExecutable', () => {
  ...
  describe('environment variable handling', () => {
    it('should throw error when DISABLE_LOCAL_CHROMIUM_DISCOVERY is set', () => {
      ...
      expect(() => findChromiumExecutable()).toThrow('Local Chromium discovery disabled by configuration');
    });

    it('should throw error when skipLocalDiscovery parameter is true', () => {
      expect(() => findChromiumExecutable(true)).toThrow('Local Chromium discovery disabled by configuration');
    });
  ...
  describe('function behavior', () => {
    ...
    it('should respect environment variable over parameter', () => {
      ...
      expect(() => findChromiumExecutable(false)).toThrow('Local Chromium discovery disabled by configuration');
    });
